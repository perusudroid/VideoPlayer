...
import com.perusudroid.player.visibility.items.ListItemData;
...
public class SingleListViewItemActiveCalculator extends BaseItemsVisibilityCalculator {
     ...
     */
    private ListItemData mCurrentItem = new ListItemData();
    ...
    /**
     * Methods of this callback will be called when new active item is found {@link Callback#activateNewCurrentItem(ListItem, View, int, int)}
    ...
    public interface Callback<T extends ListItem>{
        void activateNewCurrentItem(T newListItem, View currentView, int itemPosition);
    ...
    private void setCurrentItem(ListItemData newCurrentItem) {
        ...
        if(SHOW_LOGS) Logger.v(TAG, "setCurrentItem, newCurrentItem " + newCurrentItem.getIndex());
