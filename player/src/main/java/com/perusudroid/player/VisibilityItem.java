...
public class VisibilityItem implements ListItem {
    ...
    public VisibilityItem(String title, String videoId, String videoImage, ItemCallback callback) {
        mTitle = title;
    ...
    public void setActive(View newActiveView, int newActiveViewPosition) {
        ...
        TextView textWaveTitle = newActiveView.findViewById(R.id.textViewTitle);
        ImageView imageViewItems = newActiveView.findViewById(R.id.imageViewItem);
